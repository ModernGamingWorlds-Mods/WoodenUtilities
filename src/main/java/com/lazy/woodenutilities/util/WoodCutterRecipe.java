...
public class WoodCutterRecipe extends SingleItemRecipe {
    ...
    public WoodCutterRecipe(ResourceLocation recipeLoaction, String group, Ingredient ingredient, ItemStack result, String modId) {
        super(ModRecipeTypes.WOOD_CUTTER, ModRecipeSerializers.WOODCUTTING.get(), recipeLoaction, group, ingredient, result);
        this.modId = modId;
    }

    public WoodCutterRecipe(Ingredient ingredient, ItemStack result, String modId) {
        this(new ResourceLocation(WoodenUtilities.MOD_ID, result.getItem().getRegistryName().getPath()), "", ingredient, result, modId);
    }
    ...
    public static class Serializer<T extends WoodCutterRecipe> extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
        ...
        public T read(ResourceLocation recipeId, JsonObject json) {
            ...
            String modId = JSONUtils.getString(json, "modid", "minecraft");
            ...
            return this.factory.create(recipeId, group, ingredient, stack, modId);
        }
        ...
        public void write(PacketBuffer buffer, T recipe) {
            ...
            buffer.writeString(recipe.modId);
            recipe.ingredient.write(buffer);
            buffer.writeItemStack(recipe.result);
        }

        public interface IRecipeFactory<T extends WoodCutterRecipe> {
            T create(ResourceLocation id, String group, Ingredient ingredient, ItemStack stack, String modId);
        }
    }
}
